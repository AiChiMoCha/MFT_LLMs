...
Usage:
    python sae_steer_by_layer_final_qwen_top_10_range_100.py \
        --csv_path mft_sae_feature_candidates_qwen.csv \
        --mfq_path MFQ2.json \
        --output_path results/sae_steering_results_qwen_top_10_range_100.json \
        --n_rollouts 5
...
class SAESteeringExperiment:
    ...
    ALPHA_RANGE = [-100, -75, -50, -25, 0, 25, 50, 75, 100]
