...
OUTPUT_PATH = f"result/fineweb_feature_activations_llama.json"
CORPUS_CACHE_PATH = f"fineweb_corpus_cache_a40_{N_CORPUS_SAMPLES}.json"

# Model configuration
MODEL_NAME = "meta-llama/Llama-3.1-8B-Instruct"
SAE_RELEASE = "llama-3.1-8b-instruct-andyrdt"  # SAELens release name
...
def get_sae_id(layer: int) -> str:
    ...
    # Format for llama-3.1-8b-instruct-andyrdt release
